CREATE TABLE IF NOT EXISTS `#__pf_configs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `config_key` varchar(50) DEFAULT NULL,
  `config_value` text,
  PRIMARY KEY (`id`)
) CHARACTER SET `utf8`;
DROP TABLE IF EXISTS `#__pf_countries`;
CREATE TABLE IF NOT EXISTS `#__pf_countries` (
...
INSERT INTO `#__pf_countries` (`country_id`, `zone_id`, `name`, `country_3_code`, `country_2_code`, `published`) VALUES
...
DROP TABLE IF EXISTS `#__pf_currencies`;
CREATE TABLE IF NOT EXISTS `#__pf_currencies` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `currency_code` varchar(10) DEFAULT NULL,
  `currency_name` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) CHARACTER SET `utf8`;
INSERT INTO `#__pf_currencies` (`id`, `currency_code`, `currency_name`) VALUES
...
(23, 'THB', 'Thai Baht');
CREATE TABLE IF NOT EXISTS `#__pf_fields` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__pf_forms` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT NULL,
  `amount` decimal(10,2) DEFAULT NULL,
  `late_payment_date` datetime DEFAULT NULL,
  `late_amount_type` tinyint(3) unsigned DEFAULT NULL,
  `late_payment_amount` decimal(10,2) DEFAULT NULL,
  ...
  `enter_amount` tinyint(4) NOT NULL DEFAULT '0',
  `fee_calculation_script` text,
  `form_layout` varchar(50) DEFAULT NULL,
  `attachment` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) CHARACTER SET `utf8`;
CREATE TABLE IF NOT EXISTS `#__pf_payments` (
...
CREATE TABLE IF NOT EXISTS `#__pf_form_fields` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `form_id` int(11) DEFAULT NULL,
  `field_id` int(11) DEFAULT NULL,
  `ordering` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `#__pf_payment_plugins` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__pf_coupons` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `form_id` int(11) DEFAULT NULL,
