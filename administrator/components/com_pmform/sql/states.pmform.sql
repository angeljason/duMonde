DROP TABLE IF EXISTS `#__pf_states`;
CREATE TABLE IF NOT EXISTS `#__pf_states` (
...
INSERT INTO `#__pf_states` (`state_id`, `country_id`, `state_name`, `state_3_code`, `state_2_code`) VALUES
