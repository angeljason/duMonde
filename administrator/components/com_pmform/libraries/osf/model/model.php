...
class POSFModel
{
	 ...
	 *        	
	 * @return POSFModel A model object
	 */
	...
	public function __construct($config = array())
	{
		...
		{
			$this->table = $this->tablePrefix . strtolower(POSFInflector::pluralize($this->name));
		}
	...
	public function getTable($name = '')
	{
		if (!$name)
		{
			$name = POSFInflector::singularize($this->name);
		}				
		return JTable::getInstance($name, $this->classPrefix . 'Table');								
	}
	 ...
	 *        	
	 * @return mixed <string, POSFModelState>
	 */
	 ...
	 *
	 * @return POSFModelState The state object
	 */
