 ...
 * @since		1.0
 */
class POSFModelAdmin extends POSFModel
{
	 ...
	 *
	 * @param POSFInput $input the input data which users entered
	 *
	 */
	...
	public function publish($pks, $value = 1)
	{
		...
		if ($this->triggerEvents)
		{
			...
			JPluginHelper::importPlugin($this->pluginGroup);
			$result = JDispatcher::getInstance()->trigger($this->eventChangeState, array($this->context, $pks, $value));
		}
