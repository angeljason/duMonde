...
.red {
	...
	<div id="installer-right">
		...
		<?php if ($messages['modules']) { ?>
			...
			<?php } ?>
		<?php } ?>
		<h2>Changelog v1.50.26</h2>
		<ul class="version-history">
			<li><span class="version-fixed">Fix</span> Field name was not validated correctly in some cases.</li>
			<li><span class="version-fixed">Fix</span> In some particular cases, backups could not be restored.</li>
		</ul>
