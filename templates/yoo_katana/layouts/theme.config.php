...
$this['asset']->addFile('css', 'css:datatables.min.css');
...
$this['asset']->addFile('js', 'js:jquery.battatech.excelexport.js');
$this['asset']->addFile('js', 'js:custom_export_table.js');
$this['asset']->addFile('js', 'js:datatables.min.js');
