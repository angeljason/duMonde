function getexporttoxlsq() { 
	$("#insert_searchps").btechco_excelexport({
                containerid: "insert_searchps", datatype: $datatype.Table
            });
	} 
    ...
    $(document).ready(function() {
        $('#form7z')
		    ...
		    $("#searchbtnxz").click(function(e) {	
		    e.preventDefault();
		        $('#form7z').bootstrapValidator('validate');
		        			var bootstrapValidator = $('#form7z').data('bootstrapValidator');
							...
							{		
									...
									$.ajax({
									type: "POST",
									url: "searchscreener.php",
									data: dataString,
									cache: false,									
												beforeSend: function(html) 
												{			   
													$("#flashps").show();
													$("#flashps").html('<img src="ajax-loader.gif" align="absmiddle">&nbsp;Searching Database...Please Wait.');	
													$('#insert_searchps').empty();	
												},															
											  success: function(html)
											    {											    												       	
												   $("#insert_searchps").show();
												   $('#insert_searchps').empty();
												   $("#insert_searchps").append(html);
												   $("#flashps").hide();		
