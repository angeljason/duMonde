		    ...
		    $('#step7nextbtn').click(function(e) {
		        ...
		        $('#form7').bootstrapValidator('validate');
							...
							{								
									...
									var weto8 = $("#weto8").val();	
									var weresonforleaving8 = optionradioresult8;
									...
									'&refcompletename3='+ refcompletename3+'&refpositionappliedfor3='+ refpositionappliedfor3+'&refcontactnos3='+  refcontactnos3+	
									'&refcompletename4='+ refcompletename4+'&refpositionappliedfor4='+ refpositionappliedfor4+'&refcontactnos4='+  refcontactnos4+	
									'&refcompletename5='+ refcompletename5+'&refpositionappliedfor5='+ refpositionappliedfor5+'&refcontactnos5='+  refcontactnos5+'&prefjobfunc2='+  prefjobfunc2+'&uploadedfile='+  uploadedfile+
									'&philhealth='+  philhealth+'&mycompanyid='+  mycompanyid+'&twitter='+  twitter+'&instagram='+  instagram;									
