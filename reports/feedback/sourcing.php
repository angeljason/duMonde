...
?>	
					                ...
					                <div class="col-lg-12">
					                	<div class="input-group">
							                ...
							                <span class="input-group-btn">
							                    <button class="btn btn-default" type="button" id="searchbtn" name="searchbtn"><span class="glyphicon glyphicon-search"></span></button>
							                </span>
							            </div>              	
				                </div>               
				  </form>          
																						...
																						<div class="form-group">
																							<label>Event Name<strong>&nbsp;(* required field)</strong></label>
																									<select class="form-control" id="eventname" name="eventname"> 																									 		   
																											 <?php
																											  $queryapplicantprofilestat = "SELECT * FROM applicantprofilestattb";
																											  $resultapplicantprofilestat = pg_query($conn, $queryapplicantprofilestat);
																												while ($rowapplicantprofilestat= pg_fetch_array($resultapplicantprofilestat, NULL, PGSQL_ASSOC))
																												{	
																												  $applicantstatusidx= $rowapplicantprofilestat['id'];
																												  $applicantprofilestat = $rowapplicantprofilestat['applicantprofilestat'];					  
																												 ?>
																											 <option value="<?php echo "$applicantstatusidx"; ?>"> <?php echo "$applicantprofilestat"; ?> </option>
																											<?php
																											}
																											?>					  
																									</select>
																            ...
																            <!-- /.row -->
																                ...
																                <div class="row">																                   
																                    <div class="col-lg-6">
																                            <div class="form-group">
																                                <label>Logical</label>
																								<select class="form-control" name="oz" id="oz">
																                    ...
																                    <div class="col-lg-6">
																                            <div class="form-group">
																                                <label>Assignment</label>
																                                        <select class="form-control" name="tz" id="tz">
																											<?php
																										          if($usergroupid==1)
																													{                							 
    ...
    <script src="js/sourcingtable.js"></script>
	...
	<!-- IDLE TIMER-->
    <script type="text/javascript" src="js/idle2.js"></script> 
