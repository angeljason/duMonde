	...
	ruleText += '	.global {background-color: #D6F8CD; text-align: center}';
	ruleText += '	.course {background-color: #FFD3BD; text-align: center}';
	ruleText += '	.user {background-color: #DCE7EC; text-align: center}';
