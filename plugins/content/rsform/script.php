...
class plgContentRSFormInstallerScript
{
	public function postflight($type, $parent) {
		...
		<h3>RSForm! Pro Content Plugin v1.50.17 Changelog</h3>
		<ul class="version-history">
			<li><span class="version-new">New</span> Can prefill field values by adding them in the placeholder (eg. {rsform 20 fieldname="fieldvalue"})</li>
		</ul>
		<?php if ($pluginId) { ?>
