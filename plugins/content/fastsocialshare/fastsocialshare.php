...
class plgContentFastSocialShare extends JPlugin {
	...
	private function getContent(&$article, &$params, $moduleContext = false) {
		...
		return '<div class="fastsocialshare_container"><div class="main-container"><div class="fixer-container">' . $html . '<div class="fastsocialshare_clearer"></div></div></div></div><p>&nbsp;</p>';
	}
