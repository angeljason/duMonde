...
class plgSystemRSFPRegistrationInstallerScript
{
	...
	public function postflight($type, $parent) {
		...
		<h3>RSForm! Pro Joomla! User Registration Plugin v1.5.2 Changelog</h3>
		<ul class="version-history">
			<li><span class="version-new">New</span> Ability to specify a Menu Item ID for the activation links.</li>
		</ul>
