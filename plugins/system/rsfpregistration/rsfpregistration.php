...
class plgSystemRSFPRegistration extends JPlugin
{
	...
	public function rsfp_bk_onAfterShowFormEditTabs() {
		...
		<div class="rsform_error"><?php echo JText::_('PLG_SYSTEM_RSFPREGISTRATION_DESC'); ?></div>
		<fieldset>
	...
	public function rsfp_bk_onAfterShowFormEditTabsTab() {
		$this->_loadLanguage();
		?>
		<li><a href="javascript: void(0);" id="joomlaregistration"><span><?php echo JText::_('RSFP_REG_TITLE'); ?></span></a></li>
		<?php
	}
