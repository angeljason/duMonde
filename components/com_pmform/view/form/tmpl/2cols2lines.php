...
<div id="pmform-form" class="row-fluid pf-container">
	...
	?>
	<form method="post" name="os_form" id="os_form" action="<?php echo $url ; ?>" autocomplete="off" class="form" enctype="multipart/form-data">
		<?php
		if (!$this->userId && $this->config->user_registration)
		{
			...
			?>
			<div class="registration-form-container form-horizontal clearfix">
				<div class="control-group">
...
<div class="payment-information-container form-horizontal clearfix">
<?php
