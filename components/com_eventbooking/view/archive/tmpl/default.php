				...
				<div class="eb-description">
					<div class="<?php echo $rowFluidClass; ?>">
						...
						<div class="<?php echo $span5Class; ?>">
							<table class="table table-bordered table-striped" id="tblExport">
								...
								?>
							</table>								<div class="uk-grid">									<div class="uk-width-1-1">										<div class="uk-grid">											<div class="uk-width-1-1 uk-pull-1-1 uk-text-right">												<a href="#" id="btnExport">													<i class="uk-icon-download"></i>&nbsp;Export to Excel												</a>											</div>										</div>									</div>								</div>		
						</div>
					</div>
