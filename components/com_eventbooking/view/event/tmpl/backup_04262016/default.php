						...
						<td>
							<?php
							   ...
							   else
							   {
								   ...
								   //$datex=JHtml::_('date', $item->event_date, $this->config->event_date_format, null) ;
								   //echo $date2 = date("m-d-Y",strtotime($datex));
								   //echo JHtml::_('date', $item->event_date, 'm', null)."-".JHtml::_('date', $item->event_date, 'd', null)."-".JHtml::_('date', $item->event_date, 'Y', null); 
								   echo JHtml::_('date', $item->event_date, 'd', null)."/".JHtml::_('date', $item->event_date, 'm', null)."/".JHtml::_('date', $item->event_date, 'Y', null); 
					...
					<tr>
						...
						<td>
							<?php
							   ...
							   {
								   //echo JHtml::_('date', $item->event_date, $this->config->event_date_format, null) ;
								   //$timex=JHtml::_('date', $item->event_date, $this->config->event_date_format, null) ;
								   //echo $timex2 = date("g:i a",strtotime($timex));
								   echo JHtml::_('date', $item->event_date, 'g', null).":".JHtml::_('date', $item->event_date, 'i', null)." ".JHtml::_('date', $item->event_date, 'a', null); 
							   }
							?>
						</td>
					</tr>
